...
## О проекте
Это проект **School 21**. Я участвовал в разработке логики игрового движка Pong.

* **Мой вклад:** Я реализовал основную игровую механику и физику в директории `src`.
* **Технологии:** C, Makefile.
* **Роль:** Backend / Разработчик игрового движка.
